...
public class Game extends Canvas implements Runnable {
	...
	public Game() {
		...
		new Window(WIDTH, HEIGHT, "DodgeBlox", this);
		...
		if(gameState == STATE.Menu || gameState == STATE.End  || gameState == STATE.Shop || gameState == STATE.Help) {
	...
	private void render() {
		...
		if(paused) {
			...
			g.drawString("PAUSED", WIDTH / 2, 100);
		}
